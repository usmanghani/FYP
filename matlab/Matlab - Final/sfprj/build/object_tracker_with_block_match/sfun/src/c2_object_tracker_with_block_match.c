...
static SFc2_object_tracker_with_block_matchInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_object_tracker_with_block_match(void);
static void initialize_params_c2_object_tracker_with_block_match(void);
static void enable_c2_object_tracker_with_block_match(void);
static void disable_c2_object_tracker_with_block_match(void);
static void finalize_c2_object_tracker_with_block_match(void);
static void sf_c2_object_tracker_with_block_match(void);
...
static void sf_save_state_c2_object_tracker_with_block_match(FILE *c2_file);
static void sf_load_state_c2_object_tracker_with_block_match(FILE *c2_file);
...
static void initialize_c2_object_tracker_with_block_match(void)
{
  ...
  chartInstance.c2_is_active_c2_object_tracker_with_block_match = 0U;
}
...
static void sf_save_state_c2_object_tracker_with_block_match(FILE *c2_file)
{
  fwrite(&chartInstance.c2_is_active_c2_object_tracker_with_block_match, 1,
   sizeof(chartInstance.
    c2_is_active_c2_object_tracker_with_block_match), c2_file);
...
static void sf_load_state_c2_object_tracker_with_block_match(FILE *c2_file)
{
  fread(&chartInstance.c2_is_active_c2_object_tracker_with_block_match, 1,
   sizeof(chartInstance.
    c2_is_active_c2_object_tracker_with_block_match), c2_file);
...
/* SFunction Glue Code */
void sf_c2_object_tracker_with_block_match_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_object_tracker_with_block_match_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_object_tracker_with_block_match(void
 *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S);
  initialize_params_c2_object_tracker_with_block_match();
  initialize_c2_object_tracker_with_block_match();
}

static void sf_opaque_enable_c2_object_tracker_with_block_match(void
 *chartInstanceVar)
{
  enable_c2_object_tracker_with_block_match();
}

static void sf_opaque_disable_c2_object_tracker_with_block_match(void
 *chartInstanceVar)
{
  disable_c2_object_tracker_with_block_match();
}

static void sf_opaque_gateway_c2_object_tracker_with_block_match(void
 *chartInstanceVar)
{
  sf_c2_object_tracker_with_block_match();
}

static void sf_opaque_terminate_c2_object_tracker_with_block_match(void
 *chartInstanceVar)
{
  finalize_c2_object_tracker_with_block_match();
}

static void mdlProcessParameters_c2_object_tracker_with_block_match(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_object_tracker_with_block_match(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("object_tracker_with_block_match",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("object_tracker_with_block_match",2,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 3, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"object_tracker_with_block_match",2,4);
      sf_mark_chart_reusable_outputs(S,"object_tracker_with_block_match",2,3);
    }
    if
    (!sf_is_chart_instance_optimized_out("object_tracker_with_block_match",2)) {
      int dtId;
      char *chartInstanceTypedefName =
        sf_chart_instance_typedef_name("object_tracker_with_block_match",2);
...
static void mdlRTW_c2_object_tracker_with_block_match(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "object_tracker_with_block_match", 2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void
sf_save_debug_c2_object_tracker_with_block_match(SFc2_object_tracker_with_block_matchInstanceStruct*
...
static void
sf_load_debug_c2_object_tracker_with_block_match(SFc2_object_tracker_with_block_matchInstanceStruct*
 chartInstance,FILE* file)
{
  int machineNumber = _object_tracker_with_block_matchMachineNumber_;
  int chartNumber = chartInstance->chartNumber;
...
static void sf_c2_object_tracker_with_block_match_sim_ctx_io(SimStruct* S, const
 char io, FILE* file)
{
  if(io == 'r') {
    sf_load_state_c2_object_tracker_with_block_match(file);
    sf_load_debug_c2_object_tracker_with_block_match(&chartInstance, file);
  } else {
    sf_save_state_c2_object_tracker_with_block_match(file);
    sf_save_debug_c2_object_tracker_with_block_match(&chartInstance, file);
  }
}
static void mdlStart_c2_object_tracker_with_block_match(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_object_tracker_with_block_match;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_object_tracker_with_block_match;
  ...
  ssSetmdlSimulationContextIO(S,
   sf_c2_object_tracker_with_block_match_sim_ctx_io);
  if(!sim_mode_is_rtw_gen(S)) {
    init_dsm_address_info();
  }
}

void c2_object_tracker_with_block_match_method_dispatcher(SimStruct *S, int_T
 method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_object_tracker_with_block_match(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_object_tracker_with_block_match(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_object_tracker_with_block_match(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c2_object_tracker_with_block_match_method_dispatcher.\n"
