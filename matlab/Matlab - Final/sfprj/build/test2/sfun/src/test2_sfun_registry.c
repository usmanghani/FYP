...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_test2_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_test2_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_test2_autoinheritance_info( int nlhs, mxArray * plhs[],
   int nrhs, const mxArray * prhs[] );
  if(sf_test2_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_test2_method_dispatcher(SimStruct *S, const char
...
{
  if(sf_test2_method_dispatcher(simstructPtr,chartName,method,data)) return 1;
  return 0;
}
extern void test2_terminator(void);
...
extern void test2_initializer(void);
extern void test2_register_exported_symbols(SimStruct* S);
extern void test2_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  test2_register_exported_symbols(S);
}
